/**
 * @file dsp_ops.h
 * @brief Board-specific DSP operations for AT32F403 (Cortex-M4F).
 *
...
#if !defined(ARM_MATH_CM4) && !defined(AT32)
#warning "AT32 DSP Header included but ARM_MATH_CM4 not defined"
#endif
